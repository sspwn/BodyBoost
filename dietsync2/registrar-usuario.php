...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['name'])) {
            ...
            $tipo_user = addslashes($_POST['tipo_user']);
            ...
            if (!empty($nome) && !empty($sobrenome) &&  !empty($tipo_user) && !empty($meta) && !empty($sexo) && !empty($data_nasc) && !empty($peso) && !empty($altura) && !empty($email) && !empty($senha)) {
                if ($usuario->VerificarEmail($email)) {
                    ...
                    $registrar_user = $usuario->CadastrarUser($nome, $sobrenome,$tipo_user, $meta, $sexo, $data_nasc, $peso, $altura, $email, $senha);
                }
            }
        }
    }
    ...
    <div class="login-card-container">
        <div class="login-card">
            ...
            <form class="login-card-form" method="POST">
                ...
                <div class="form item">
                    <label for="tipo_user">Selecione o tipo de usuário</label>
                    <select name="tipo_user" id="tipo_user" class="form-select" required>
